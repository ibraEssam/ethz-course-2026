...
def ik_track(
    ...
    for i in range(max_iters):
        ...
        eef_pos = data.site(site_name).xpos
        err_pos = np.array(target_pos) - eef_pos
        ...
        x = np.linalg.solve(a=J @ J.T + damping_i, b=weighted_err)
